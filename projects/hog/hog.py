...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls > 0:
        ...
        if roll == 1:
            ...
            current_score += roll
        num_rolls -= 1
    return auto_one or current_score
    # END PROBLEM 1
...
def free_bacon(opp_score):
    ...
    """
    assert opp_score < 100, 'The game should be over.'
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    mul_diff = (2 * (opp_score // 10) - opp_score % 10)
    if mul_diff < 1:
        return 1
    else:
        return mul_diff
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls == 0:
        ...
        total_score = turn_score + total_score
    else:
...
def is_swap(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    p_score_tens = player_score % 100
    o_score_tens = opponent_score % 100
    ones_player = p_score_tens % 10
    tens_player = p_score_tens // 10
    ones_opponent = o_score_tens % 10
    tens_opponent = o_score_tens // 10
    if abs(ones_player - tens_player) - abs (ones_opponent - tens_opponent) == 0:
        return True
    else:
        return False
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if who == 0:
            ...
            p_score = score1
        current_high = p_score - pre_score
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    gains = free_bacon(opponent_score)
    score_increase = score + gains
    if is_swap(score_increase, opponent_score) and score_increase < opponent_score:
        return 0
    elif gains >= margin and not is_swap(score_increase, opponent_score):
        return 0
    return num_rolls
    # END PROBLEM 11
